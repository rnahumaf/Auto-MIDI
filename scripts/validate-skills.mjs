...
const skills = [
  "design-musical-structure",
  "generate-midi-arrangements",
  "synchronize-video-cues",
];
...
for (const skill of skills) {
  const result = spawnSync(process.env.PYTHON || "python", [validator, resolve(".agents", "skills", skill)], {
    stdio: "inherit",
  });
